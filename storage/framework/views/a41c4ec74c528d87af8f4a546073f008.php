    ...
    <li class="nav-item">
        ...
        <div id="colorCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo e(route('colors.index')); ?>">Colors</a>
            <a class="collapse-item" href="<?php echo e(route('colors.create')); ?>">Add color</a>
          </div>
        </div>
    </li>
...
<?php /**PATH /home/scarycolony/PhpstormProjects/Complete-Ecommerce-in-laravel-10/resources/views/backend/layouts/sidebar.blade.php ENDPATH**/ ?>