<?php $__env->startSection('main-content'); ?>
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="<?php echo e(route('products-colors.create', $product->id)); ?>" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add color</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
          ...
          <tbody>
            ...
            <?php $__currentLoopData = $product->colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td>
                        <?php if($color->pivot->path): ?>
                            <?php
                              $photo=explode(',',$color->pivot->path);
                              // dd($photo);
                            ?>
                    ...
                    <td>
                    <form method="POST" action="<?php echo e(route('products-colors.destroy',[$product->id, $color->id])); ?>">
                      <?php echo csrf_field(); ?>
        ...
        <?php else: ?>
          <h6 class="text-center">No colors found!!! Please create product color</h6>
        <?php endif; ?>
      </div>
    </div>
</div>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/scarycolony/PhpstormProjects/Complete-Ecommerce-in-laravel-10/resources/views/backend/products-colors/index.blade.php ENDPATH**/ ?>