<?php $__env->startSection('meta'); ?>
    ...
    <?php if(\request()->get('photo')): ?>
        <meta property="og:image" content="<?php echo e(\request()->get('photo')); ?>">
    <?php else: ?>
									...
									<div class="col-lg-6 col-12">
										...
										<div class="product-gallery">
											...
											<div class="flexslider-thumbnails">
												<ul class="slides">
                                                    <?php if(\request()->get('photo')): ?>
                                                        <li data-thumb="<?php echo e(\request()->get('photo')); ?>" rel="adjustX:10, adjustY:">
                                                            <img src="<?php echo e(\request()->get('photo')); ?>" alt="<?php echo e(\request()->get('photo')); ?>">
                                                        </li>
                                                    <?php else: ?>
                                                        <?php
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="color">
												...
												<ul>
                                                    <?php $__currentLoopData = $product_detail->colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li><a href="<?php echo e(route('product-detail', [
                                                            'slug' => $product_detail->slug,
                                                            'photo' => $color->pivot->path])); ?>"><img src="<?php echo e($color->path); ?>" alt="#"></a></li>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
												</ul>
											</div>
											<!--/ End Color -->
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/scarycolony/PhpstormProjects/Complete-Ecommerce-in-laravel-10/resources/views/frontend/pages/product_detail.blade.php ENDPATH**/ ?>