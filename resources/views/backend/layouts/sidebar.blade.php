<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
      ...
      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item" href="{{route('banner.create')}}">Добавить баннер</a>
        </div>
      </div>
    </li>
    <!-- Divider -->
    ...
    <li class="nav-item">
        ...
        <div id="categoryCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Настройки категории:</h6>
    ...
    <li class="nav-item">
        ...
        <div id="productCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Настройки товаров:</h6>
    ...
    <li class="nav-item">
      ...
      <div id="postCollapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <h6 class="collapse-header">Настройки публикаций:</h6>
          <a class="collapse-item" href="{{route('post.index')}}">Публикации</a>
          <a class="collapse-item" href="{{route('post.create')}}">Добавить публикацию</a>
        </div>
      </div>
    </li>
