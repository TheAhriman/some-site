...
<style type="text/css">
  ...
  <section class="order_details pt-3">
    ...
    <table class="table table-bordered table-stripe">
      <thead>
        <tr>
          <th scope="col" class="col-6">Продукт</th>
          <th scope="col" class="col-3">Количество</th>
          <th scope="col" class="col-3">Общая сумма</th>
        </tr>
      </thead>
      <tbody>
      ...
      @endphp
        <tr>
          ...
          <td><span>{{number_format($cart->price,2)}}BR</span></td>
        </tr>
      @endforeach
      </tbody>
      <tfoot>
        <tr>
          ...
          <th scope="col" class="text-right">Промежуточный итог:</th>
          <th scope="col"> <span>{{number_format($order->sub_total,2)}}BR</span></th>
        </tr>
      ...
      @endif --}}
        <tr>
          ...
          <th><span>{{number_format($shipping_charge[0],2)}}BR</span></th>
        </tr>
        <tr>
          <th scope="col" class="empty"></th>
  ...
  <div class="thanks mt-3">
    <h4>Спасибо за ваше сотрудничество !!</h4>
  </div>
