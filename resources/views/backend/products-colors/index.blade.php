...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('products-colors.create', $product->id)}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add color</a>
    </div>
    <div class="card-body">
          ...
          <tbody>
            ...
            @foreach($product->colors as $color)
                <tr>
                    ...
                    <td>
                    <form method="POST" action="{{route('products-colors.destroy',[$product->id, $color->id])}}">
                      @csrf
                      @method('delete')
