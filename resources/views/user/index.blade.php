      ...
      <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-success shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Товары</div>
      ...
      <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-warning shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Статьи</div>
            ...
            @if(count($orders)>0)
              @foreach($orders as $order)   
                <tr>
                    ...
                    <td>
                        <a href="{{route('user.order.show',$order->id)}}" class="btn btn-warning btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="Предосмотр" data-placement="bottom"><i class="fas fa-eye"></i></a>
              ...
              @endforeach
              @else
                <td colspan="8" class="text-center"><h4 class="my-4">У вас пока нет заказов! Пожалуйста, закажите что-нибудь</h4></td>
              @endif
          </tbody>
        </table>
